  ...
  return (
    <>
      ...
      <div>
        ...
        <div className="w-[155px] h-[260px] bg-[#25293C] rounded-md relative">
          ...
          <div className="p-1 flex flex-col gap-2">
            <div className="flex flex-col">
              <div className="text-white text-[12px]">Iphone 12</div>
              <div className="text-gray-500 text-[10px]">Apple</div>
            </div>
            <Rating>
              <Rating.Star />
              <p className="text-[10px] text-white">4.95</p>
